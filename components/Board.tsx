...
const Board: React.FC<BoardProps> = ({ translations, language, onBack }) => {
  ...
  const refreshPosts = async () => {
    ...
    // Convert Firestore ISO dates to readable local dates if needed
  ...
  const renderCreateView = () => (
    <div className="w-full max-w-2xl mx-auto animate-fade-in-up">
      ...
      {/* UGC Policy Warning - Critical for AdSense */}
      <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 mb-6 flex items-start space-x-3">
        ...
        <p className="text-sm text-yellow-800">{translations.ugcWarning}</p>
      </div>
            ...
            {!isGuide && (
              <div className="mt-8 pt-6 border-t border-gray-100">
                <p className="text-xs text-gray-400">
                  Disclaimer: This content is user-generated. The views expressed here do not necessarily reflect the views of PolitiCompass.
                </p>
              </div>
            )}
          </div>
