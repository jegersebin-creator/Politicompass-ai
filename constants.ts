...
// Korean Translation of the Data
const IDEOLOGIES_KO: QuadrantInfo[] = [
  {
    name: "권위주의적 좌파 (Authoritarian Left)",
    description: "경제적 평등 달성을 위해 강력한 국가 개입을 지지하며, 사회 질서 유지를 위해 개인의 자유보다 공동체의 규율을 중시합니다.",
    items: [
      {
        name: "마르크스-레닌주의",
        coords: { x: -10, y: 8 },
        definition: "레닌이 제국주의 시대의 마르크스주의를 러시아의 현실에 맞게 계승·발전시킨 사상입니다.",
        explanation: "자본주의가 스스로 붕괴하기를 기다리지 말고, 소수의 정예 혁명가 집단인 '전위당(공산당)'이 노동자를 이끌어 혁명을 일으켜야 한다고 주장합니다. 혁명 후 자본가 계급의 반격을 막기 위해 일정 기간 '프롤레타리아 독재'가 필요하며, 이 기간 동안 강력한 국가 통제와 계획 경제를 시행합니다.",
      ...
      },
      {
        name: "스탈린주의 / 마오주의",
        coords: { x: -9, y: 9.5 },
        definition: "마르크스-레닌주의가 지도자의 통치 철학과 결합하여 더욱 극단화된 형태입니다.",
        explanation: "스탈린주의: '일국사회주의'를 내세우며 소련 내부의 공업화와 국방력 강화에 집중했습니다. 정적에 대한 가혹한 숙청, 정보 통제, 개인 숭배가 특징입니다. 마오주의: 농업 국가였던 중국의 현실을 반영하여 도시 노동자가 아닌 '농민'을 혁명의 주체로 보았습니다. 끊임없는 내부 투쟁(문화대혁명 등)을 강조했습니다.",
      ...
      },
      {
        name: "종교 사회주의",
        coords: { x: -6, y: 4 },
        definition: "특정 종교의 교리를 바탕으로 사회주의적 경제 체제를 지향하는 사상입니다.",
        explanation: "'부자가 천국에 가는 것은 낙타가 바늘구멍을 통과하는 것보다 어렵다'와 같은 종교적 가르침을 사회 구조적 맥락에서 해석합니다. 자본주의적 탐욕을 죄악시하며, 신의 뜻에 따라 가난한 자를 위한 분배와 복지를 주장합니다. 라틴 아메리카의 '해방 신학'이 대표적입니다.",
      ...
      },
      {
        name: "국가 사회주의",
        coords: { x: -5, y: 6 },
        definition: "혁명적 공산주의와 달리, 국가가 생산 수단을 소유하고 경제를 주도하는 체제를 의미합니다.",
        explanation: "경제를 자본가에게 맡기면 불평등과 비효율이 발생하므로, 국가가 거대한 기업처럼 산업을 관리해야 한다고 봅니다. 비스마르크의 사회 정책이나 페비언 협회의 초기 사상처럼, 위로부터의 개혁을 통해 노동자의 삶을 개선하려는 경향이 있습니다.",
  ...
  },
  {
    ...
    description: "시장 경제와 사유 재산을 옹호하지만, 국가 안보, 전통, 도덕적 질서를 위해 국가가 사회를 강력하게 통제합니다.",
    items: [
      {
        name: "전제 군주제 (Absolute Monarchy)",
        coords: { x: 5, y: 9 },
        definition: "군주가 입법·사법·행정의 모든 권력을 독점하는 전근대적 통치 형태입니다.",
        explanation: "통치권은 신으로부터 부여받았다는 '왕권신수설'에 기반합니다. 군주의 의지가 곧 법이며, 의회나 헌법에 구속받지 않습니다. 현대 민주주의 관점에서는 독재로 분류되지만, 역사적으로는 봉건적 혼란을 잠재우고 중앙집권 국가를 만드는 역할을 했습니다.",
        figures: "루이 14세, 토머스 홉스",
        keywords: "왕권신수설, 충성, 계급사회"
      },
      {
        name: "파시즘 / 나치즘",
        coords: { x: 2, y: 9.5 },
        definition: "국가를 하나의 살아있는 유기체로, 개인을 그 부속품으로 보는 극단적 민족주의 및 전체주의 사상입니다.",
        explanation: "민주주의의 다원성을 '분열'로 규정하고 혐오합니다. 강력한 1인 독재자가 민족을 통합해야 한다고 믿으며, 내부 결속을 다지기 위해 외부의 적이나 특정 인종(예: 유대인)을 탄압합니다. 전쟁과 폭력을 정화의 수단으로 미화하기도 합니다.",
        figures: "베니토 무솔리니, 아돌프 히틀러",
        keywords: "전체주의, 국수주의, 반공주의, 인종주의(나치즘)"
      },
      {
        name: "네오콘 (신보수주의)",
        coords: { x: 6, y: 5 },
        definition: "자유주의적 가치를 보존하기 위해 무력(군사력) 사용도 불사하는 미국의 현대 우파 사상입니다.",
        explanation: "과거 좌파 운동권 출신이 보수로 전향하며 형성된 경우가 많습니다. 자국의 이익과 민주주의 확산을 위해 국제 사회에 적극적으로 개입(전쟁 포함)해야 한다고 믿습니다. 경제적으로는 시장 경제를 지지하지만, 작은 정부보다는 '강한 정부'를 선호합니다.",
      ...
      },
      {
        ...
        coords: { x: 4, y: 9.5 },
        definition: "종교 지도자가 정치 권력을 갖고, 종교법이 국가의 통치 원리가 되는 체제입니다.",
        explanation: "정교분리를 거부합니다. 경전(성경, 쿠란 등)의 내용이 곧 헌법이며, 종교 경찰이 시민의 사생활, 복장, 행동을 감시하고 처벌합니다. 현대의 이란이나 아프가니스탄의 탈레반 정권이 대표적입니다.",
  ...
  },
  {
    ...
    description: "경제적 불평등 해소를 최우선으로 하되, 강압적인 국가 통제보다는 개인의 자유와 자발적 연대를 추구합니다.",
    items: [
      {
        name: "민주 사회주의",
        coords: { x: -7, y: -2 },
        definition: "민주적 절차(선거, 의회)를 통해 사회주의의 이상을 실현하려는 사상입니다.",
        explanation: "혁명이나 독재를 반대합니다. 하지만 사민주의와 달리 자본주의 체제 자체를 극복 대상으로 보며, 주요 산업의 공공 소유나 노동자 자주 관리 기업 등을 통해 경제 시스템의 근본적 변화를 꾀합니다.",
      ...
      },
      {
        name: "사회 민주주의",
        coords: { x: -4, y: -2 },
        definition: "자본주의 시장 경제를 인정하되, 적극적인 국가 개입으로 불평등을 완화하고 복지 국가를 건설하려는 사상입니다.",
      ...
      },
      {
        name: "녹색 정치",
        coords: { x: -5, y: -5 },
        definition: "생태적 지혜, 사회 정의, 비폭력, 풀뿌리 민주주의를 핵심 가치로 삼는 사상입니다.",
        explanation: "산업화 중심의 성장 정책(좌우파 막론하고)을 비판합니다. 기후 위기 대응, 탈원전, 성소수자 인권, 동물권 등 현대적 의제를 주도합니다. 의사 결정 과정에서 권위적 리더십보다 합의와 참여를 중시합니다.",
      ...
      },
      {
        name: "아나키즘 / 아나코-코뮤니즘",
        coords: { x: -9.5, y: -9 },
        definition: "모든 형태의 계급과 국가 권력을 철폐하고, 자발적 상호 부조에 기초한 공동체를 지향합니다.",
        explanation: "국가를 '억압의 도구'로 보고 거부합니다. 사유 재산을 철폐하고 생산 수단을 공동체 내에서 공유하되, 중앙에서 통제하는 공산주의 국가와 달리 지역 단위의 자유로운 결사체에 의해 생산과 분배가 결정됩니다.",
        figures: "표트르 크로포트킨, 미하일 바쿠닌",
        keywords: "무정부, 상호 부조, 자율적 연대"
      }
    ]
  },
  {
    name: "자유주의적 우파 (Libertarian Right)",
    description: "개인의 자유와 재산권을 최고의 가치로 여기며, 국가의 간섭(세금, 규제)을 악으로 규정하거나 최소화를 추구합니다.",
    items: [
      {
        name: "고전적 자유주의",
        coords: { x: 5, y: -3 },
        definition: "개인의 자유, 사유 재산권, 자유 시장 경제, 법치주의를 강조하는 근대 시민 사회의 기반 사상입니다.",
        explanation: "봉건제와 절대 왕정에 저항하며 등장했습니다. 국가는 국방, 치안 등 최소한의 역할(야경 국가)에 머물고, 경제는 '보이지 않는 손'에 의해 조절되도록 내버려둬야 한다고 믿습니다.",
        figures: "존 로크, 애덤 스미스",
      ...
      },
      {
        name: "신자유주의",
        coords: { x: 4, y: -1 },
        definition: "20세기 후반, 케인스주의(국가 개입)의 실패를 비판하며 시장 원리의 전면적 확대를 주장한 사상입니다.",
        explanation: "국가의 복지 지출 축소, 공기업 민영화, 노동 시장 유연화, 자유 무역 협정(FTA) 등을 추진합니다. 경쟁을 통한 효율성 증대가 전체의 부를 키운다고 믿지만, 양극화를 심화시킨다는 비판을 받습니다.",
      ...
      },
      {
        name: "리버테리언 (자유지상주의)",
        coords: { x: 8, y: -7 },
        definition: "자신의 신체와 재산에 대한 절대적 소유권을 주장하며, 국가의 침해를 거부하는 사상입니다.",
        explanation: "경제적 자유뿐만 아니라 사회적 자유도 중시합니다. 마약 사용, 성매매, 도박 등도 '타인에게 피해를 주지 않는 한' 개인의 선택이라고 봅니다. 징병제를 반대하고 총기 소유의 자유를 옹호하는 경우가 많습니다.",
        figures: "로버트 노직, 론 폴",
        keywords: "자기 소유권, 최소 국가, 세금은 절도다"
      },
      {
        name: "아나코-캡 (무정부 자본주의)",
        coords: { x: 9.5, y: -9.5 },
        definition: "국가 자체를 완전히 철폐하고, 모든 사회 기능을 시장에 맡겨야 한다는 극단적 자유주의 사상입니다.",
        explanation: "경찰, 법원, 도로 건설 등 공공재로 여겨지는 영역조차 민간 기업이 서비스로 제공해야 한다고 믿습니다. 분쟁은 국가 법원이 아닌 사설 중재 기관을 통해 해결합니다. 자본주의 시장 원리가 곧 사회 질서가 되는 세상입니다.",
        figures: "머리 로스바드, 데이비드 프리드먼",
        keywords: "국가 철폐, 사설 치안, 시장 절대주의"
      }
    ]
  },
  {
    name: "주요 미국 정치인 (Major US Figures)",
    description: "전현직 미국 대통령 및 주요 정치적 영향력자들의 정치 이념 분석 보고서입니다.",
    items: [
      {
        name: "도널드 트럼프 (Donald Trump)",
        coords: { x: 5, y: 7 },
        definition: "공화당 (Republican Party)",
        explanation: "'MAGA(미국을 다시 위대하게)' 운동을 이끄는 인물로, 공화당의 전통적 보수주의(자유무역, 개입주의)와 결이 다릅니다. 이념적으로는 '권위주의적 우파'에 가깝습니다. 경제적으로는 관세 부과 등 보호무역을 통해 자국 산업을 보호하려 하며, 사회적으로는 강력한 국경 통제와 반이민 정책으로 '미국 우선주의'를 내세웁니다.",
        figures: "우파 포퓰리즘, 국가 보수주의",
        keywords: "보호무역, 반이민, 반기득권"
      },
      {
        name: "찰리 커크 (Charlie Kirk)",
        coords: { x: 6, y: 6 },
        definition: "보수 활동가 / Turning Point USA 설립자",
        explanation: "청년층을 타겟으로 하는 보수 논객으로 트럼프주의의 이념적 기반을 제공하는 핵심 인물 중 하나입니다. 경제적 자유주의(감세)를 지지하지만, 최근에는 '문화 전쟁'에 더 집중하는 모습을 보입니다. 대학과 기업이 좌파 이념(PC주의)에 점령당했다고 보고, 기독교 가치 복원과 전통적 가족관 수호를 위해 국가가 적극 개입해야 한다고 주장합니다.",
        figures: "뉴라이트, 기독교 민족주의",
        keywords: "문화 전쟁, 반-PC, 기독교 가치"
      },
      {
        name: "조 바이든 (Joe Biden)",
        coords: { x: 2, y: 2 },
        definition: "민주당 (Democratic Party)",
        explanation: "민주당 내 온건파를 대표하는 인물입니다. 급진적 변화보다는 점진적 개혁을 선호합니다. '바이드노믹스'로 대표되듯, 정부가 인프라, 반도체 등 핵심 산업에 적극 투자하고 노조를 강화하여 중산층을 복원하려는 '친노동 자본주의' 성향을 보입니다. 외교적으로는 트럼프의 고립주의를 반대하고 동맹과의 연대를 중시하는 전통적 국제주의 노선을 따릅니다.",
        figures: "사회 자유주의, 중도주의",
        keywords: "중산층 복원, 국제 동맹, 큰 정부 투자"
      },
      {
        name: "버락 오바마 (Barack Obama)",
        coords: { x: 3, y: 1 },
        definition: "민주당 (Democratic Party)",
        explanation: "이상적인 수사를 사용하지만 정책적으로는 시장 친화적 해법을 선호하는 실용주의자입니다. '오바마케어'가 대표적인데, 국가가 의료를 전담하기보다 민간 보험 시장을 개혁해 보장성을 넓히는 방식을 택했습니다. 사회적으로는 동성 결혼 합법화 등 진보적 가치를 옹호했으나, 경제·외교적으로는 급진 좌파와 거리를 두었습니다.",
        figures: "제3의 길, 실용적 진보",
        keywords: "실용주의, 사회 정의, 글로벌 협력"
      },
      {
        name: "버니 샌더스 (Bernie Sanders)",
        coords: { x: -5, y: -2 },
        definition: "무소속 (민주당 코커스)",
        explanation: "미국 정치권에서 가장 좌측에 있는 인물 중 하나입니다. 스스로 '민주 사회주의자'라 칭하지만, 실제 정책은 북유럽식 '사회민주주의'에 가깝습니다. 자본주의의 구조적 불평등을 강하게 비판하며, 건강보험의 완전 국유화(Medicare for All)와 부유세 도입을 주장합니다.",
        figures: "민주 사회주의, 사회 민주주의",
        keywords: "부의 재분배, 보편적 의료, 반기업 정서"
      },
      {
